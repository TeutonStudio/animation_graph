...
# from .UI.editorheader import ANIMGRAPH_HT_node_header
# from .UI.newgraph import ANIMGRAPH_OT_new
# from .UI.groupedit import ANIMGRAPH_OT_group_edit, ANIMGRAPH_OT_tree_path_parent
...
#        type=AnimNodeTree,
#        description="AnimGraph node tree assigned to this armature",
#    )
#    kc = bpy.context.window_manager.keyconfigs.addon
#    if kc:
#        km = kc.keymaps.new(name="Node Editor", space_type="NODE_EDITOR")
#        kmi = km.keymap_items.new("riggraph.group_make", type="G", value="PRESS", ctrl=True)
#        addon_keymaps.append((km, kmi))

#    bpy.utils.register_class(ANIMGRAPH_OT_group_edit)
#    bpy.utils.register_class(ANIMGRAPH_OT_tree_path_parent)
#    bpy.utils.register_class(ANIMGRAPH_OT_open_in_node_editor)
#    bpy.utils.register_class(ANIMGRAPH_HT_node_header)
#    bpy.utils.register_class(ANIMGRAPH_OT_new)
#    bpy.utils.register_class(RIGGRAPH_OT_path_pop_to)
#    bpy.utils.register_class(RIGGRAPH_OT_interface_add_socket)
#    bpy.utils.register_class(RIGGRAPH_OT_interface_remove_socket)
...
#    bpy.utils.unregister_class(ANIMGRAPH_OT_group_edit)
#    bpy.utils.unregister_class(ANIMGRAPH_OT_tree_path_parent)
#    bpy.utils.unregister_class(ANIMGRAPH_OT_open_in_node_editor)
#    bpy.utils.unregister_class(ANIMGRAPH_HT_node_header)
#    bpy.utils.unregister_class(ANIMGRAPH_OT_new)
#    bpy.utils.unregister_class(RIGGRAPH_OT_path_pop_to)
#    bpy.utils.unregister_class(RIGGRAPH_OT_interface_add_socket)
#    bpy.utils.unregister_class(RIGGRAPH_OT_interface_remove_socket)
#    bpy.utils.unregister_class(DATA_PT_riggraph)
